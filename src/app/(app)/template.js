      ...
      <body className={lato.className}>
        <Toaster />
          <main className="md:flex min-h-screen">
            ...
            <label htmlFor="navCb" className="md:hidden ml-8 mt-4 p-4 rounded-md 
            bg-white shadow inline-flex items-center gap-2 cursor-pointer">
            ...
            <aside className="bg-white w-48 p-4 pt-6 shadow fixed md:static -left-48 
              top-0 bottom-0 z-20 transition-all">

              <div className="sticky top-0 pt-2">
              <div className="rounded-full overflow-hidden aspect-square w-24 mx-auto flex items-center justify-center">
